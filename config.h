...
static const char *scratchpadcmd[] = {
    ...
    scratchpadname,
    "-o",
    "window.dimensions = { columns = 135, lines = 35 }",
    NULL};
...
static Key keys[] = {
    ...
    /* { 0, XF86XK_AudioPrev,		spawn,		{.v = (const char*[]){
       "mpc", "prev", NULL } } }, */
    /* { 0, XF86XK_AudioNext,		spawn,		{.v = (const char*[]){
       "mpc",  "next", NULL } } }, */
    /* { 0, XF86XK_AudioPause,		spawn,		{.v = (const char*[]){
       "mpc", "pause", NULL } } }, */
    /* { 0, XF86XK_AudioPlay,		spawn,		{.v = (const char*[]){
       "mpc", "play", NULL } } }, */
    /* { 0, XF86XK_AudioStop,		spawn,		{.v = (const char*[]){
       "mpc", "stop", NULL } } }, */
    /* { 0, XF86XK_AudioRewind,	spawn,		{.v = (const char*[]){ "mpc",
       "seek", "-10", NULL } } }, */
    /* { 0, XF86XK_AudioForward,	spawn,		{.v = (const char*[]){
       "mpc", "seek", "+10", NULL } } }, */
    /* { 0, XF86XK_AudioMedia,		spawn,		{.v = (const char*[]){
       TERMINAL, "-e", "ncmpcpp", NULL } } }, */
    /* { 0, XF86XK_AudioMicMute,	spawn,		SHCMD("pactl
       set-source-mute @DEFAULT_SOURCE@ toggle") }, */
    /* /\* { 0, XF86XK_PowerOff,		spawn,		{.v = (const
       char*[]){ "sysact", NULL } } }, *\/ */
    /* { 0, XF86XK_Calculator,		spawn,		{.v = (const char*[]){
       TERMINAL, "-e", "bc", "-l", NULL } } }, */
    /* { 0, XF86XK_Sleep,		spawn,		{.v = (const char*[]){
       "sudo", "-A", "zzz", NULL } } }, */
    /* { 0, XF86XK_WWW,		spawn,		{.v = (const char*[]){ BROWSER,
       NULL } } }, */
    /* { 0, XF86XK_DOS,		spawn,		{.v = termcmd } }, */
    /* { 0, XF86XK_ScreenSaver,	spawn,		SHCMD("slock & xset dpms force
       off; mpc pause; pauseallmpv") }, */
    /* { 0, XF86XK_TaskPane,		spawn,		{.v = (const char*[]){
       TERMINAL, "-e", "htop", NULL } } }, */
    /* { 0, XF86XK_Mail,		spawn,		SHCMD(TERMINAL " -e
       neomutt ; pkill -RTMIN+12 dwmblocks") }, */
    /* { 0, XF86XK_MyComputer,		spawn,		{.v = (const char*[]){
       TERMINAL, "-e",  "lfub",  "/", NULL } } }, */
    /* /\* { 0, XF86XK_Battery,		spawn,		SHCMD("") }, *\/ */
    /* { 0, XF86XK_Launch1,		spawn,		{.v = (const char*[]){
    ...
    /* { 0, XF86XK_TouchpadOn,		spawn,		{.v = (const char*[]){
       "synclient", "TouchpadOff=0", NULL } } }, */
    /* { 0, XF86XK_MonBrightnessUp,	spawn,		{.v = (const char*[]){
       "xbacklight", "-inc", "15", NULL } } }, */
    /* { 0, XF86XK_MonBrightnessDown,	spawn,		{.v = (const char*[]){
       "xbacklight", "-dec", "15", NULL } } }, */
